                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        image: const DecorationImage(
                            image: AssetImage('images/images/donation.png'),
                            fit: BoxFit.fill),
              ...
              child: SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return DonationBox(context, campaign: campaign[index]);
                  },
...
DonationBox(context, {required Campaign campaign}) {
                            ...
                            child: IconButton(
                                onPressed: () {
                                  Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                          builder: (context) =>
                                              DonationDetail(campaign: campaign)));
                                },
                                icon: const Icon(
